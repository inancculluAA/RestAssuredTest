...
//                        .log().body()
    ...
    @Test
    public void getUserByIDExtratct() {
...
//        response.as(); // tüm gelen response uygun nesnelerin yapılması gerekiyor.
        ...
        List<User> dataUsers = response.jsonPath().getList("data", User.class); // JSONPATH bir response içindeki bir parçayı nesneye dönüştürebiliyoruz.
